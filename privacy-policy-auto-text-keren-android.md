...
Child Safety and CSAE Compliance

"Our application has a zero-tolerance policy regarding Child Sexual Abuse and Exploitation (CSAE). We are committed to providing a safe environment and strictly prohibit the creation, distribution, or promotion of any material that exploits or abuses children. We comply with international standards and will cooperate with law enforcement agencies, including reporting any illegal activity to the National Center for Missing & Exploited Children (NCMEC), to ensure the safety of minors."
